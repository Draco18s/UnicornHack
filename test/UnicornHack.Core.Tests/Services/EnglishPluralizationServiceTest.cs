...
{
    public class EnglishPluralizationServiceTest : IClassFixture<EnglishPluralizationServiceTest.TestFixture>
    {
        [Theory]
        ...
        {
            Assert.Equal(expectedPlural, Fixture.EnglishPluralizationService.Pluralize(noun));
        }
        ...
        [InlineData("to sway", "sways")]
        public void Verbs_are_pluralized(string verb, string expectedPlural)
        {
            Assert.Equal(expectedPlural, Fixture.EnglishPluralizationService.GetSForm(verb));
        }

        protected TestFixture Fixture { get; }
        public EnglishPluralizationServiceTest(TestFixture fixture)
        {
            Fixture = fixture;
        }
        ...
        {
            public EnglishPluralizationService EnglishPluralizationService { get; } = new EnglishPluralizationService();
        }
    }
}
